...
githubを使わない人でも、同じように一目見て、過去の思い出を色だけで構成されたカレンダーを見ることで楽しめるアプリを作成したいと思ったことが開発の理由です。

## 対象とするユーザー層
- 忙しい社会人・学生 — まとまった入力時間を確保しにくい
- ウェルビーイングを意識する個人 — 日々の感情を手軽に記録し、セルフケアに役立てたい
- ライティングが苦手／スマホ入力が遅い人 — 音声入力なら心理的ハードルが低い
- 子育て・介護中のユーザー — 両手がふさがっていても記録できる
- カウンセリングやコーチングを受けているクライアント — 客観的な感情の変化を共有したい

## ユーザーが抱える具体的課題
- 入力のハードルが高い — キーボード入力、フリック入力や手書きは時間と集中を要し、継続が難しい
...
- Gemini による感情スコアリング & カラーヒートマップラッセルの円環モデル（快／不快 × 覚醒／沈静）に沿って (x, y) 座標を算出し、ユーザーが設定したパレットで色を決定。GitHub 風ヒートマップ UI に反映し、月・年単位で一目で気分の波を把握できます。
- ゲーミフィケーションで継続を促進ヒートマップの空白（未登録日）がひと目で分かるため、自然と「今日も記録しよう」という気持ちが湧き、継続率を向上。
...
<img src="./screen_shot/Screenshot_20250619-193744.png" width="300">
<img src="./screen_shot/Screenshot_20250619-193749.png" width="300">
